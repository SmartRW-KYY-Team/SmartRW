                    ...
                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                        ...
                        @endif
                            <form action="{{ route('login.post') }}" method="post">
                                ...
                                <div class="mb-4">
                                    <label for="password" class="form-label" style="font-weight: 500; font-size: 20px">Password</label>
                                    <input type="password" id="password" name="password" class="form-control form-control-lg" style="background-color: #B0BAC3; border-radius: 20px; height: 64px;" placeholder="Masukkan Password" />
                                </div>
                                <div class="pt-1 mb-4 d-flex justify-content-center">
                                    <button class="btn btn-lg" type="submit" style="background-color: #0B7077; color: #FFFFFF; width: 278px">Login</button>
                                </div>
                        </div>
                    </div>
