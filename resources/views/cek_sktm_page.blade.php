...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/style_status_sktm.css') }}">
  <style>
    .required:after {
        content: "*";
        color: red;
...
<body style="background-color: #f2f7ff">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item active" href="{{ route('cek_sktm_page') }}">Status SKTM</a>
  ...
  <div class="form-section">
    ...
    <div class="card mx-auto" style="max-width: 800px;">
        <div class="card-header"><h5 class="card-title" style="background-color: #0b7077;">Cek Status Surat Keterangan Tidak Mampu (SKTM) Anda</h5></div>
        <div class="card-body">
        <form>
