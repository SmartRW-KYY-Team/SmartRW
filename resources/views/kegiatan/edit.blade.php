...
@section('content')
    ...
    <div class="card-body">
        <form action="{{ url('/kegiatan/' . $kegiatan->id_kegiatan . '/update') }}" method="POST"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                            name="nama" value="{{ old('nama', $kegiatan->nama) }}">
                        @error('nama')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="exampleFormControlTextarea1" rows="2"
                            name="deskripsi">{{ old('deskripsi', $kegiatan->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('lampiran') is-invalid @enderror" type="file" id="formFile"
                            name="lampiran" value="{{ old('lampiran', $kegiatan->lampiran) }}">
                        @error('lampiran')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_kegiatan') is-invalid @enderror"
                            id="tanggal_kegiatan" name="tanggal_kegiatan" required
