...
<head>
    ...
    <title>SMARTRW - Laporan Keuangan RT</title>
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.11.5/css/jquery.dataTables.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/style_keuangan_rt.css') }}">
</head>
...
<body style="background-color: #f2f7ff">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item active" href="{{ route('keuanganWarga.rt.index') }}">RT</a>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="display-4">Laporan Keuangan RT</h1>
                    <p class="lead">
                        Lihat laporan keuangan RT secara langsung
                    </p>
                </div>
    ...
    <div class="container mt-4">
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="card-title" style="background-color: #0b7077;">Lihat Laporan Keuangan RT</h5>
            </div>
            <div class="card-body">
                <div class="dropdown">
