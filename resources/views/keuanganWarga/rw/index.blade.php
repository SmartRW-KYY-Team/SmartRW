    ...
    <section>
        <div class="container py-5">
            <div class="title text-center pt-5">
                <h1>Keuangan Rukun Warga</h1>
            </div>
            <div class="card my-5 shadow">
                <div class="card-header">
                    <h5 class="card-title" text-color="black">Lihat Laporan Keuangan RW</h5>
                </div>
                <div class="card-body">
                    <div class="dropdown mb-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="rw-dropdown">
                            <li><a class="dropdown-item active" href="#" data-rw-id="1">RW 4</a></li>
                        </ul>
                    </div>
