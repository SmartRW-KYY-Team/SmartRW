...
<head>
    ...
    <title>SMARTRW - Layanan Pengajuan Surat Domisili</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/image/favicon.png') }}">
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('assets/style_domisili.css') }}">
    <style>
        .required:after {
            content: "*";
            color: red;
...
<body style="background-color: #f2f7ff">
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="display-4">Layanan Pengajuan Surat Domisili</h1>
                    <p class="lead">
